const app = function () {
	...
	const CATEGORIES = ['accelerator','ai','agile', 'blockchain','cocreation','codesample','courses','databases','designthinking', 'design', 'environment','events','education', 'governance','hacking','industry4.0','lectures','markets','meta','methods','ML','mobility','people','product','robotics','socialmedia','startups','scrum','templates','tools','ux','vc','voice internet'];	const state = {activePage: 1, activeCategory: null};
	const page = {};
