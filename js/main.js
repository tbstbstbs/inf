const app = function () {
	...
	const CATEGORIES = ['Voice Internet', 'Cyber Security', 'Smart Cities', 'User Experience', 'Education & Learning', 'Ventures & Business Models', 'Coding & Tools', 'Science Deep Dives', 'Interviews', 'Global Trade', 'New Work', 'Open Source', ];	const state = {activePage: 1, activeCategory: null};
	const page = {};
