const app = function () {
	...
	const CATEGORIES = ['ai','agile', 'blockchain','data science','mobility','smart cities','ux','vc','voice internet',];	const state = {activePage: 1, activeCategory: null};
	const page = {};
	...
	function _buildFilter () {
	    page.filter.appendChild(_buildFilterLink('See All', false));
		...
		posts.forEach(function (post) {
			...
			article.innerHTML = `
				...
				<div class="article-details">
					<div>Source ${post.author} on ${_formatDate(post.timestamp)}</div>
